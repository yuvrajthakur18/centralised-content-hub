          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="h5" color="white" mb={0.5}>
                Get started with Content Hub
              </ArgonTypography>
              <ArgonTypography variant="body2" color="white">
                Unify, Sync, and Master Content With Ease, Bring all content together in one place
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
              Expand your reach with global synchronization, Connect your content to every corner of the world
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
